                    ...
                    <div class="dashboard__left__main">
                        ...
                        <div class="dashboard__top">
                            <div class="dashboard__top__logo">
                                <a href="{{ url('/') }}">
                                    ...
                                    <img class="iocn_view__logo" src="{{ asset('assets/img/Favicon.png') }}"
                                        alt="logo_icon">
                                </a>
                            </div>
                        </div>
                        <div class="dashboard__bottom mt-5">
                            ...
                            <ul class="dashboard__bottom__list dashboard-list">
                                ...
                                <li
                                    class="dashboard__bottom__list__item has-children {{ Route::is('country.index') ? 'active' : '' }}">
                                    <a href="{{ route('country.index') }}"><span class="icon_title">All
                                            Countries</span></a>
                                </li>
                                <li
                                    class="dashboard__bottom__list__item has-children {{ Route::is('state.index') ? 'active' : '' }}">
                                    <a href="{{ route('state.index') }}"><span class="icon_title">All
                                            State</span></a>
                                </li>
                                <li
                                    class="dashboard__bottom__list__item has-children {{ Route::is('city.index') ? 'active' : '' }}">
                                    <a href="{{ route('city.index') }}"><span class="icon_title">All
                                            City</span></a>
                                </li>
                                    ...
                                    <div class="dashboard__header__right__flex">
                                        <div class="dashboard__header__right__item responsive_search">
                                            <a href="javascript:void(0)"
                                                class="dashboard__search__icon search__click"> <i
