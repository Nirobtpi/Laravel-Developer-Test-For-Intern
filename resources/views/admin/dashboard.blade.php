        ...
        <div class="dashboard__inner__item">
            <div class="dashboard__inner__item__flex">
                <div class="dashboard__inner__item__left bodyItemPadding">
                            ...
                            <div class="dashboard__inner__header__right">
                                <div class="dashboard__inner__item__right recent_activities">
                                    <div class="btn-wrapper">
                                        <a href="javascript:void(0)" class="cmn_btn btn_small radius-5"
                                            id="activity_btn">Show
                                            Activities</a>
                                    </div>
                                    <div class="dashboard__recentActivities bg__white padding-20">
                                        <div class="dashboard__recentActivities__flex">
                                            ...
                                            <span class="dashboard__recentActivities__close"><i
                                                    class="material-symbols-outlined">close</i></span>
                                        </div>
                                                    ...
                                                    <div class="dashboard__recentActivities__single__flex">
                                                        <div class="dashboard__recentActivities__single__thumb">
                                                            <a href="javascript:void(0)"><img
                                                                    src="html/assets/img/recent_activities/activities1.jpg"
                                                                    alt="activities"></a>
                                                        </div>
                                                        <div class="dashboard__recentActivities__single__contents">
                                                            <h6 class="dashboard__recentActivities__single__title"><a
                                                                    href="javascript:void(0)">Gown party wear is sold 01
                                                                    piece</a></h6>
                                                            <p class="dashboard__recentActivities__single__time mt-2">10 Min
                                                                ago
                                                            </p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="dashboard__recentActivities__item">
                                                <div class="dashboard__recentActivities__single">
                                                    <div class="dashboard__recentActivities__single__flex">
                                                        <div class="dashboard__recentActivities__single__thumb">
                                                            <a href="javascript:void(0)"><img
                                                                    src="html/assets/img/recent_activities/activities2.jpg"
                                                                    alt="activities"></a>
                                                        </div>
                                                        <div class="dashboard__recentActivities__single__contents">
                                                            <h6 class="dashboard__recentActivities__single__title"><a
                                                                    href="javascript:void(0)">This product is running low on
                                                                    stock</a></h6>
                                                            <p class="dashboard__recentActivities__single__time mt-2">1
                                                                Hours
                                                                ago</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="dashboard__recentActivities__item">
                                                <div class="dashboard__recentActivities__single">
                                                    <div class="dashboard__recentActivities__single__flex">
                                                        <div class="dashboard__recentActivities__single__thumb">
                                                            <a href="javascript:void(0)"><img
                                                                    src="html/assets/img/recent_activities/activities3.jpg"
                                                                    alt="activities"></a>
                                                        </div>
                                                        <div class="dashboard__recentActivities__single__contents">
                                                            <h6 class="dashboard__recentActivities__single__title"><a
                                                                    href="javascript:void(0)">This product is added to
                                                                    stock</a>
                                                            </h6>
                                                            <p class="dashboard__recentActivities__single__time mt-2">2
                                                                Hours
                                                                ago</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="dashboard__recentActivities__item">
                                                <div class="dashboard__recentActivities__single">
                                                    <div class="dashboard__recentActivities__single__flex">
                                                        <div class="dashboard__recentActivities__single__thumb">
                                                            <a href="javascript:void(0)"><img
                                                                    src="html/assets/img/recent_activities/activities4.jpg"
                                                                    alt="activities"></a>
                                                        </div>
                                                        <div class="dashboard__recentActivities__single__contents">
                                                            <h6 class="dashboard__recentActivities__single__title"><a
                                                                    href="javascript:void(0)">Rafael is moved to Elgine St.
                                                                    Branch</a></h6>
                                                            <p class="dashboard__recentActivities__single__time mt-2">3
                                                                Hours
                                                                ago</p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="dashboard__recentActivities__item">
                                                <div class="dashboard__recentActivities__single">
                                                    <div class="dashboard__recentActivities__single__flex">
                                                        <div class="dashboard__recentActivities__single__thumb">
                                                            <a href="javascript:void(0)"><img
                                                                    src="html/assets/img/recent_activities/activities5.jpg"
                                                                    alt="activities"></a>
                                                        </div>
                                                        <div class="dashboard__recentActivities__single__contents">
                                                            <h6 class="dashboard__recentActivities__single__title"><a
                                                                    href="javascript:void(0)">Robert F is added in Herbert
                                                                    St.
                                                                    Branch as General Staff</a></h6>
                                                            <p class="dashboard__recentActivities__single__time mt-2">4
                                                                Hours
                                                                ago</p>
                                                        </div>
                                                    </div>
                    ...
                    <div class="alert alert-danger mt-4 rounded-2 fw-bold">Please review the README file to fully understand
                        your task.</div>
                        ...
                        <div class="row g-4 mt-2">
                            <div class="col-xxl-3 col-xl-4 col-sm-6">
                                <div class="dashboard_promo__single bg__white radius-10 padding-20">
                                    ...
                                    <p class="dashboard_promo__single__para mt-3"><span class="percentage"> +20%</span> Than
                                        last month</p>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-4 col-sm-6">
                                <div class="dashboard_promo__single bg__white radius-10 padding-20">
                                    ...
                                    <p class="dashboard_promo__single__para mt-3"><span class="percentage">+19%</span> Than
                                        last
                                        month</p>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-4 col-sm-6">
                                <div class="dashboard_promo__single bg__white radius-10 padding-20">
                                    ...
                                    <p class="dashboard_promo__single__para mt-3"><span class="percentage"> +08%</span> Than
                                        last month</p>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-4 col-sm-6">
                                <div class="dashboard_promo__single bg__white radius-10 padding-20">
                                    ...
                                    <p class="dashboard_promo__single__para mt-3"><span class="percentage percentDown">
                                            -12%</span> Than last month</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr class="table_row">
                                                        ...
                                                        <div class="table_customer">
                                                            <div class="table_customer__flex">
                                                                <div class="table_customer__thumb">
                                                                    <img src="html/assets/img/customer/customer1.jpg"
                                                                        alt="customer">
                                                                </div>
                                                                <div class="table_customer__contents">
                                                                    <h6 class="table_customer__title">Naomi Russel</h6>
                                                                    <p class="table_customer__para mt-1">ckctm12@gmail.com
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td><span class="table_payment"><img
                                                                src="html/assets/img/payment_method/apple.png"
                                                                alt=""></span></td>
                                                    <td>
                                                        <p class="status_btn completed">Complete</p>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="table_row">
                                                    ...
                                                    <td><span class="table_payment"><img
                                                                src="html/assets/img/payment_method/cash.png"
                                                                alt=""></span></td>
                                                    <td>
                                                        <p class="status_btn in_progress">In Progress</p>
                                                    </td>
                                                    <td>
                                                        <div class="action__icon d-flex">
                                                            <div class="action__icon__item">
                                                ...
                                                <tr class="table_row">
                                                    ...
                                                    <td>
                                                        <div class="table_customer">
                                                            <div class="table_customer__flex">
                                                                <div class="table_customer__thumb">
                                                                    <img src="html/assets/img/customer/customer3.jpg"
                                                                        alt="customer">
                                                                </div>
                                                                <div class="table_customer__contents">
                                                    ...
                                                    <td><span class="table_payment"><img
                                                                src="html/assets/img/payment_method/google.png"
                                                                alt=""></span></td>
                                                    <td>
                                                ...
                                                <tr class="table_row">
                                                    ...
                                                    <td>
                                                        <div class="table_customer">
                                                            <div class="table_customer__flex">
                                                                <div class="table_customer__thumb">
                                                                    <img src="html/assets/img/customer/customer4.jpg"
                                                                        alt="customer">
                                                                </div>
                                                                <div class="table_customer__contents">
                                                                    <h6 class="table_customer__title">Kristin Watson</h6>
                                                    ...
                                                    <td><span class="table_payment"><img
                                                                ...
                                                                alt=""></span></td>
                                                    <td>
                                                        <p class="status_btn cancelled">Canceled</p>
                                                    </td>
                                                    <td>
                                                        <div class="action__icon d-flex">
                                                            <div class="action__icon__item">
